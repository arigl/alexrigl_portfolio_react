    ...
    <>
      ...
      <div>
        ...
        <div
          className={` ${
            showProjects
              ? "transform scale-100 transition-transform duration-1000 ease-in-out delay-500"
              : "transform scale-0"
          }`}
        >
          {/* <Tools></Tools> */}
        ...
        <div
          className={` ${
            showProjects
              ? "transform scale-100 transition-transform duration-1000 ease-in-out delay-700"
              : "transform scale-0"
          }`}
        >
        ...
        <div
          className={` ${
            showProjects
              ? "transform scale-100 transition-transform duration-1000 ease-in-out delay-1000"
              : "transform scale-0"
          }`}
        >
          <Projects
        ...
        <div className="bg-white rounded-xl shadow-sm border flex gap-10 justify-center items-center p-10 flex flex-col md:flex-row ">
          <div className="">
            <VaraText text={varaContent} />
          </div>
          <div className="flex flex-row gap-1.5 md:flex-col">
            <div className="flex flex-col">
              <h1 className="flex gap-1.5 text-xs items-center font-mono font-medium text-orange-500">
                Email
              </h1>
              <h1 className="flex gap-1.5 text-xs items-center font-mono font-medium text-black-500">
                alexrigl@gmail.com
              </h1>
            </div>
            <div className="flex flex-col items-start">
              ...
              <button
                ...
                className="pt-1 pb-1 pl-4 pr-4 text-white max-w-m bg-black hover:bg-orange-500 rounded-xl shadow-lg items-center space-x-4"
              >
                Download
              </button>
            </div>
