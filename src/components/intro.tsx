    ...
    <div className="">
      <header className="text-xl pt-12 max-w-xl mx-auto">
        <HoverCard>
          ...
          <HoverCardContent>Software Engineer since 2012.</HoverCardContent>
        </HoverCard>
        ...
        <div className="mt-4 flex divide-x gap-2 justify-center">
          <a
            ...
            href="https://www.linkedin.com/in/alex-rigl-661b02174/"
            target="_blank"
          >
            <svg
              stroke="currentColor"
          ...
          <a
            className="h-10 w-10 text-slate-600 bg-white shadow-sm hover:text-blue-600 text-xl rounded-xl flex items-center justify-center border border-slate-200"
            href="https://twitter.com/RiglDev"
            target="_blank"
          >
            <svg
              stroke="currentColor"
